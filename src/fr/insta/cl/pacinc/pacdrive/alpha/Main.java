...
import fr.insta.cl.pacinc.pacdrive.data.Data;
...
import fr.insta.cl.pacinc.pacdrive.userInterface.Viewer;
      ...
      @Override public void handle(long l) {
        ...
        switch (data.getSoundEffect()){
          case PhantomDestroyed:
            new MediaPlayer(new Media(getHostServices().getDocumentBase()+"src/fr/insta/cl/pacinc/pacdrive/sound/waterdrip.mp3")).play();
            break;
          case HeroesGotHit:
            new MediaPlayer(new Media(getHostServices().getDocumentBase()+"src/fr/insta/cl/pacinc/pacdrive/sound/waterdrip.mp3")).play();
            break;
